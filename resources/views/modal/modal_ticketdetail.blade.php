    ...
    <div class="modal-dialog">
        <form action="/booking">
            ...
            <div class="modal-body" style="padding: 25px 25px 0 25px">
                ...
                <hr  class="no-margin" />
                <div class="row">
                    <div class="col-md-12 alert-ticket" data-toggle="collapse" data-target="#alert" style="cursor: pointer; padding-top: 10px; padding-bottom: 10px;">
                        <h4 style="color: #3097D1">
                            <i class="fa fa-exclamation-triangle"></i> <strong> &nbsp;&nbsp; Đọc trước khi đăng ký vé</strong>
